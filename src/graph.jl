...
function graph_from_json(filepath::AbstractString,
    ...
    """ Arguments:
        ...
        filepath: file path to the .json file that contains the graph. This
                  ...
                  function of the Python implementation of Gerrychain. [1] We
                  assume that the JSON file has the structure of a dictionary
                  where (1) the key "nodes" yields an array of dictionaries
                  of node attributes, (2) the key "adjacency" yields an array
                  of edges (represented as dictionaries), and (3) the key "id"
                  within the edge dictionary indicates the destination node
                  of the edge.
