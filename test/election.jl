...
@testset "Election tests" begin
    ...
    @testset "update_elections_detailed()" begin
        ...
        @test election.party₁_votes == [6, 6, 6, 6]
        @test election.party₂_votes == [6, 6, 6, 6]
        @test election.party₁_vote_shares == [0.5, 0.5, 0.5, 0.5]
        @test election.party₂_vote_shares == [0.5, 0.5, 0.5, 0.5]
    end
    ...
    @testset "update_elections_Δ()" begin
        ...
        @test election.party₁_votes == [5, 7, 6, 6]
        @test election.party₂_votes == [9, 3, 6, 6]
        @test election.party₁_vote_shares == [5/14, 7/10, 6/12, 6/12]
        @test election.party₂_vote_shares == [9/14, 3/10, 6/12, 6/12]
    end
